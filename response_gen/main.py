...
try:
    ...
    print(f"Dataset cargado exitosamente. Total: {len(df)}", flush=True)
except Exception as e:
    print(f"Error al cargar el dataset: {e}", flush=True)
    df = pd.DataFrame()
...
def get_stats():
    try:
        ...
        print(f"Error consultando Redis: {e}", flush=True)
